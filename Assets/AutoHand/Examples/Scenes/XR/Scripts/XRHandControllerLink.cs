    ...
    public class XRHandControllerLink : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (device != null && device.isValid)
            {
                ...
                if (device.TryGetFeatureValue(GetCommonButton(pauseButton), out bool menu))
                {

                    if (menu != pauseLastState)
                    {
                       // Debug.Log(menu);
                        if (menu == false)
                        {
                            ...
                            {
                               // Debug.Log(GameManager.m_GameState);
                                 gameManager.Pause();
                            }
                            else if (GameManager.Instance.m_GameState == GameState.gamePause)
                            {
                                gameManager.UnPause();
                            }
                        }
